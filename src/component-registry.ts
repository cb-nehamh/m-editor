...
export const componentRegistry: ComponentDef[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { key: 'cb_appearance', label: 'Appearance', type: 'select', default: 'light', group: 'Payment Component', options: [
        { value: 'light', label: 'Light' }, { value: 'dark', label: 'Dark' },
      ]},
      { key: 'cb_radius', label: 'Border Radius', type: 'select', default: 'medium', group: 'Payment Component', options: [
        { value: 'none', label: 'None' }, { value: 'small', label: 'Small' }, { value: 'medium', label: 'Medium' },
        { value: 'large', label: 'Large' }, { value: 'full', label: 'Full' },
      ]},
      { key: 'cb_scaling', label: 'Scaling', type: 'string', default: '100%', group: 'Payment Component' },
      { key: 'cb_accentColor', label: 'Accent Color', type: 'string', default: '', group: 'Payment Component' },
      { key: 'cb_spacing', label: 'Spacing', type: 'number', default: '', group: 'Payment Component' },
      { key: 'cb_colorBackground', label: 'Background Color', type: 'string', default: '', group: 'Payment Component' },
      { key: 'cb_fontFamily', label: 'Font Family', type: 'string', default: '', group: 'Payment Component' },
      { key: 'cb_accentIndicator', label: 'Accent Indicator', type: 'string', default: '', group: 'Payment Component' },
      { key: 'cb_layoutType', label: 'Layout Type', type: 'select', default: 'tab', group: 'Payment Component', options: [
        { value: 'tab', label: 'Tab' }, { value: 'accordion', label: 'Accordion' },
      ]},
      { key: 'cb_showRadioButtons', label: 'Show Radio Buttons', type: 'boolean', default: true, group: 'Payment Component' },
      { key: 'cb_defaultItemsToShow', label: 'Default Items to Show', type: 'number', default: 3, group: 'Payment Component' },
      { key: 'cb_allowedMethods', label: 'Allowed Payment Methods', type: 'multiselect', default: ['card'], group: 'Payment Component', options: [
        { value: 'card', label: 'Card' }, { value: 'google_pay', label: 'Google Pay' },
        { value: 'apple_pay', label: 'Apple Pay' }, { value: 'paypal_express_checkout', label: 'PayPal' },
        { value: 'venmo', label: 'Venmo' }, { value: 'bancontact', label: 'Bancontact' },
        { value: 'ideal', label: 'iDEAL' }, { value: 'direct_debit', label: 'Direct Debit' },
        { value: 'upi', label: 'UPI' }, { value: 'klarna_pay_now', label: 'Klarna' },
        { value: 'amazon_payments', label: 'Amazon Pay' },
      ]},
      { key: 'cb_saveLabel', label: 'Save PM Label', type: 'string', default: 'Save this payment method', group: 'Payment Component' },
      { key: 'cb_saveDescription', label: 'Save PM Description', type: 'string', default: 'I authorize saving this payment method for future transactions.', group: 'Payment Component' },
      { key: 'cb_saveDefaultChecked', label: 'Save PM Default Checked', type: 'boolean', default: true, group: 'Payment Component' },
      { key: 'cb_buttonText', label: 'Button Text (Card)', type: 'string', default: '', group: 'Payment Component' },
      { key: 'cb_customRules', label: 'Custom CSS Rules (JSON)', type: 'json', default: {}, group: 'Payment Component' },
    ],
    features: [
