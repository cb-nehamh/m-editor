...
export function AgentPanel({
  ...
  }, [input, image, messages.length, dispatch, onProcessingChange, onStatusChange, persistMessage, setMessages]);
      ...
      <AnimatePresence>
        {image && (
          ...
          >
            ...
            <button onClick={() => setImage(null)} className="agent-image-remove">
              <X size={12} />
            </button>
          </motion.div>
        )}
